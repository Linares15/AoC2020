numbers = []
with open("Day_09/input.txt") as txt:
    for line in txt:
...
def solvePart1(numbers):
    for index in range(25, len(numbers)):
        answer = numbers[index]
        found = False
        for first in range(index - 25, index):
            for second in range (first + 1, index):
                firstGuess = numbers[first]
                secondGuess = numbers[second]
                if (firstGuess + secondGuess) == answer:
                    found = True
        if not found:
            return answer
    return 0

print(f"Part 1: {solvePart1(numbers)}")

#

def solvePart2(numbers):
    answer = solvePart1(numbers)
...
print(f"Part 2: {solvePart2(numbers)}")
