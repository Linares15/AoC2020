...
passports = []
with open("Day_04/input.txt") as puzzleInput:
    passport = Passport()
    ...
    for line in puzzleInput:
        if line == "\n":
            ...
            while match:
                ...
                line = line[end+1:]
                match = pattern.match(line)
    passports.append(passport) # @Cleanup
...
def solvePart1(passports):
    validPassports = 0
    for passport in passports:
        if ("byr" in passport.fields
        and "iyr" in passport.fields 
        and "eyr" in passport.fields 
        and "hgt" in passport.fields 
        and "hcl" in passport.fields 
        and "ecl" in passport.fields 
        and "pid" in passport.fields):
...
def solvePart2(passports):
    return 0

print("Part 1: " + str(solvePart1(passports)))
print("Part 1: " + str(solvePart2(passports)))
